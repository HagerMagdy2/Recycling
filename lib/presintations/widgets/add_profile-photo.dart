...
class AddProfilePhoto extends StatefulWidget {
  final void Function(String)? onPhotoSet; // Callback function

  const AddProfilePhoto({Key? key, this.onPhotoSet}) : super(key: key);
...
class _AddProfilePhotoState extends State<AddProfilePhoto> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    if (pickedFile != null) {
      ...
      // Call the callback function with the new photo URL
      if (widget.onPhotoSet != null) {
        widget.onPhotoSet!(imageUrl);
      }
    }
