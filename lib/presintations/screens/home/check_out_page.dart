...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  num getTotalPrice() {
    totalPrice = widget.cartProducts.fold(0, (sum, product) {
        ...
        return AlertDialog(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        icon: Icon(Icons.location_on, color: kMainColor),
                        onPressed: () async {
          ...
          actions: [
            TextButton(
              ...
              child: Text('Confirm', style: TextStyle(color: kSecondaryColor)),
            ),
            TextButton(
              onPressed: isPaymentSuccessful
                  ? () {
